        ...
        <div class=" col-12  col-md-5 mx-auto" >
            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class=" form-group">
                    <input type="text" name="" id="" class=" form-control" placeholder="Nombre del Refugio">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" name="" id="" class=" form-control" placeholder="Dirección del Refugio">
                </div>
                <div class="row">
                    <div class=" form-group col-6">
                        <input type="text" name="" id="" class=" form-control" placeholder="Capacidad">
                    </div>
                    <div class=" form-group col-6">
                        <input type="text" name="" id="" class=" form-control" placeholder="Tipo select">
                    </div>
                </div>
                <div class=" form-group">
                    <textarea class="form-control" placeholder="Descripcion del Refugio...." id="" name=""></textarea>
                </div>
